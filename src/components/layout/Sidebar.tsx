...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 border-r border-stone-800 bg-stone-950/90 flex flex-col h-[calc(100vh-3.5rem)] shrink-0 select-none shadow-[4px_0_16px_rgba(0,0,0,0.6)] z-20">
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1">
        <div className="px-2 py-1.5 text-[10px] font-mono font-bold text-amber-400 uppercase tracking-widest flex justify-between items-center border-b border-stone-800/80 mb-1">
          <span>UI ELEMENTS CATALOG</span>
          <span className="bg-stone-900 text-amber-400 px-2 py-0.5 rounded border border-amber-500/40 font-mono text-[9px] font-bold shadow-inner">
